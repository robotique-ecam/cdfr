...
void FuntechStepper::enable(void) { digitalWrite(this->pin_enable, LOW); }

void FuntechStepper::disable(void) { digitalWrite(this->pin_enable, HIGH); }
...
long FuntechStepper::getSteps(void) { return this->_steps; }

void FuntechStepper::resetSteps(void) { this->_steps = 0; }

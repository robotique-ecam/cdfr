...
if [ $robot = "asterix" ] || [ $robot = "obelix" ]; then
    ...
    generate_yamls && generate_urdfs && colcon build --symlink-install --cmake-args=" -DCMAKE_BUILD_TYPE=Release" --packages-skip assurancetourix strategix panoramix pharaon_msgs pharaon && print_success "Built packages for $robot" || print_failure "Packages build failed"

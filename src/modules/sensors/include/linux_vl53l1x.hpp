...
public:
  ...
  void setXTalk(uint16_t xTalk);                             // Manually set the value of crosstalk in counts per
  ...
  void setDistanceThreshold(uint16_t lowThresh, uint16_t hiThresh,
  ...
  * To set the center, set the pad that is to the right and above the exact
  ...
  void setSignalThreshold(uint16_t signalThreshold); // Programs the necessary threshold to trigger
                                                     // a measurement. Default is 1024 kcps.
  uint16_t getSignalThreshold();                     // Returns the signal threshold in kcps
  void setSigmaThreshold(uint16_t sigmaThreshold);   // Programs a new sigma threshold
                                                     // in mm. (default=15 mm)
  ...
  void calibrateOffset(uint16_t targetDistanceInMm); // Autocalibrate the offset by placing a target a
                                                     // known distance away from the sensor and
                                                     // passing this known distance into the function.
  void calibrateXTalk(uint16_t targetDistanceInMm);  // Autocalibrate the crosstalk by placing a

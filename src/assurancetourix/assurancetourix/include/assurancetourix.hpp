...
private:
  ...
  double mat_dist_coeffs[1][5] = {{0.74919632, -2.56720601, -0.00993371, -0.08665212, 2.85231451}};// {{0.5 * -0.05507153604545092, -0.036754144220704506, 0.004500420597462287, -0.01843020862512126, 0.017075316951618093}};
  double mat_camera_matrix_coeff[3][3] = {{1747.81086, 0.0, 651.608377},{0.0, 9462.26515, 783.705860},{0.0, 0.0, 1.0}};//  {{1.2 * 978.2290511854844, 0.0, 1.2 * 722.0173011119409}, {0.0, 1.2 * 982.4076393453565, 1.2 * 653.1296070005849}, {0.0, 0.0, 1.0}};
